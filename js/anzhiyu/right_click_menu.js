// ./node_modules/hexo-theme-anzhiyu/source/js/anzhiyu/right_click_menu.js
// 初始化函数
rm = {};
...
rm.writeClipImg = function (imgsrc) {
  // console.log("按下复制");
  rm.hideRightMenu();
  anzhiyu.snackbarShow("正在下载中，请稍后", false, 2000);
...
function addRightMenuClickEvent() {
  ...
  document.getElementById("menu-music-copyMusicName").addEventListener("click", function () {
    ...
    anzhiyu.snackbarShow("复制歌曲名称成功", false, 2000);
  });
}
